        ...
        try:
            while True:
                ...
                if results.pose_landmarks:
                    ...
                    cv2.putText(frame, f"knee angle: {knee_angle:.2f}", (50, 150),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"knee-ankle diff: {abs(left_knee[0] - left_ankle[0]):.2f}", (50, 200),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"shoulder_hip_dist: {shoulder_hip_dist:.2f}", (50, 250),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
            ...
            while True:
                ...
                if results.pose_landmarks:
                    ...
                    cv2.putText(frame, f"Push-up: {pushup_count}/{goal_count}", (50, 50),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2) #색(BGR) 
                    cv2.putText(frame, f"Set: {set_number}/{total_sets}", (50, 100),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"elbow_angle: {elbow_angle:.2f}", (50, 150),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"body_angle: {body_angle:.2f}", (50, 200),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"push_up_pose: {push_up_pose}", (50, 250),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
                    cv2.putText(frame, f"wrist_foot_y_diff: {wrist_foot_y_diff:.2f}", (50, 300),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
            ...
            for side in ["왼팔", "오른팔"]:
                ...
                while True:
                    ...
                    if results.pose_landmarks:
                        ...
                        cv2.putText(frame, f"Set: {set_number}/{total_sets}", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
                        cv2.putText(frame, f"elbow_angle: {elbow_angle:.2f}", (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
